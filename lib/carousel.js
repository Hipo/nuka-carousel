...
var Carousel = _react2['default'].createClass({
  ...
  propTypes: {
    ...
    invalidChange: _react2['default'].PropTypes.func,
  ...
  goToSlide: function goToSlide(index, nextProps) {
    var self = this;
    var props;
    if (nextProps) {
      props = nextProps;
    ...
    var isLastNext = index >= _react2['default'].Children.count(props.children);
